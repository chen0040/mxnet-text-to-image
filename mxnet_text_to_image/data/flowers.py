...
def get_data_iter(data_dir_path, glove_dir_path=None, max_sequence_length=-1, ctx=mx.cpu(),
    ...
    image_feats_dict = get_image_features(data_dir_path=data_dir_path, model_ctx=ctx)
    text_feats, image_id_array = get_text_features(data_dir_path=data_dir_path,
    ...
    for image_id in image_id_array:
        feats = image_feats_dict[image_id]
